...
The following figure reproduces the shopping time analysis from `eda/eda.ipynb` and `deployment/app.py`. It is one of the most informative views of the raw data, since it shows the only temporal pattern that the dataset actually allows.
